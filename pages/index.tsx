...
import ExampleNavbar from "../components/layout/navbar"
import Image from "next/image";
import { useState } from "react";
import { useTranslations } from "next-intl";
import { Toaster, toast } from "react-hot-toast";
import DropDown, { FormType } from "../components/DropDown";
import OptionsJobs from "../components/options/OptionsJobs";
import OptionsFocus from "../components/options/OptionsFocus";
...
const Home: NextPage = () => {
  ...
  const generateChat = async (e: any) => {
    ...
    console.log(process.env.NEXT_PUBLIC_USE_USER_KEY)
        ...
        <div className="max-w-xl w-full">
          ...
          <div className="mt-1 items-center space-x-3">
            ...
            <p className="text-slate-500" style={{ textAlign: "center" }}>
              由于费用过高，本站一分钟内仅接受 20
              次请求，迟迟不能生成周报是因为暂时限流，请收藏此网站后在低峰期使用。有任何问题请联系我的邮箱
              guaguaguaxia@Gmail.com，我会一一回复。
            </p>
          </div>
        </div>
        <Toaster
